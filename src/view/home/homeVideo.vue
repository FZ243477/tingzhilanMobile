        ...
        <div class="home_content">
            ...
            <div data-v-24bd6e66="" class="home_nav">
                <ul data-v-24bd6e66="" style="padding: 0px;">
                    <li data-v-24bd6e66="" @click="goHomeCase()">
                        <div data-v-24bd6e66="" class="home_nav_left"></div>
                        <div data-v-24bd6e66="" class="home_nav_span">图片</div>
                        <div data-v-24bd6e66="" class="home_nav_right"></div>
                    </li>
                    <li data-v-24bd6e66="" class="select" @click="goHomeVideo()">
                        <div data-v-24bd6e66="" class="home_nav_left"></div>
...
<script>
    ...
    export default {
        ...
        methods: {
            goHomeCase(){
                this.$router.push("/homeCase?id=" + 1);
            },
            goHomeVideo(){
